					...
					<div class="col-xl-12 col-lg-7">
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								...
								$sql="select * from organization where (org='$organization');"; 
								//Check whether organization already exist in database or not

								$res=mysqli_query($hubungan,$sql);

								if (mysqli_num_rows($res) > 0) {
										$row = mysqli_fetch_assoc($res);
										if($organization==isset($row['org']))
										{
											echo "<center><div class='alert alert-danger'>Sorry, the Organization already exists in our database<br> <a href='add_org.php'> Go Back !</a></div></center>";
										}
								}else{
									//put query to insert record
									$q1 = "insert into organization (org)
									values ('".$organization."')"; 
									...
									if(!$resultInsert){
										...
										echo "<div class='alert alert-success'>Organization was inserted successfully.<a href='add_org.php'> Go Back!</a></div>";
									}
								}
								?>
								</div>
