                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
									...
									$queryDelete = "delete from NOMINEE where id = '".$id."' ";

									$resultDelete = mysqli_query($conn, $queryDelete); //assign query Delete to a variable 

									if(!$resultDelete){
									die ("Query bermasalah : ".mysqli_error($conn));
									}
									else {
										echo "<center><div class='alert alert-danger'>Nominee was deleted successfully.
										<br><a href='add_nominee.php'> Go Back !</a></div></center>";
										}
									}
									?>
									</div>
