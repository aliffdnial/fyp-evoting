            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ADMINISTRATOR EDIT ORGANIZATION</h1>
                    </div>
                                ...
                                <div class="card-body">
									...
									if (!$conn) {
									  die("Connection failed: " . mysqli_connect_error());
										...
										$queryGet = "select * from ORGANIZATION where id = '".$id."' ";
										...
										//query result is OK
									?>
									<form action="EditOrg.php" name="UpdateForm" method="POST" >

									<?php
									//retrieve all $resultGet result
									while($baris = mysqli_fetch_array($resultGet, MYSQLI_BOTH)) {?>

									Organization ID: <?php echo $baris['id']; ?>
									 
									<br><br>Organization: <input type="text" name="org" value="<?php 
									echo $baris['org']; //To Edit Organization Name ?>" maxlength="20" size ="35" required>
									<?php
										}
									?>
									<br><br>
									...
									<!-- Upon click on Update button, it will go to editorg.php page to update the edited name of organization -->
									</form>
									<?php
										}
									}
