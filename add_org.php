		...
		<!-- End of Topbar -->
			...
			<div class="container-fluid">
				...
				<div class="d-sm-flex align-items-center justify-content-between mb-4">
					<h1 class="h3 mb-0 text-gray-800">ADMINISTRATOR ADD ORGANIZATION</h1>
				</div>
				...
				<div class="row">
					...
					<div class="col-xl-12 col-lg-7">
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<?php $id=$_SESSION['ID']; ?>
								<!-- Assign Session ID to variable $id -->
								<div class="chart-area" style="height:800px;">
									<form method="POST" action="add_orgSubmit.php" role="form">
										<div class="form-group-sm">
											<!-- <label for="organization">Organization</label>
											<input required type="text" name="organization" size="60" maxlength="60">
											To Insert Organization -->
											<label for="organization">Organization</label>
											<!-- Choose What Organization to be added -->
									...
									<br><br>
									<!-- List of Organization will be display -->
									<h4>List of Organizations</h4><hr>
									<?php
									$conn = mysqli_connect("localhost","root","","evoting");
									$query = "select * from organization ";
									$query_run = mysqli_query($conn,$query);
									//Query to display organization that exists in database
									?>
										...
										foreach($query_run as $row)
										{
											?>
												<tr>
													...
													<td><a href="EditViewOrg.php?id=<?php echo $row['id']; //To Edit ?>"><i class="far fa-edit"></i></a></td>
													<td><a href="DeleteViewOrg.php?id=<?php echo $row['id']; //To Delete ?>"><i class="far fa-trash-alt"></i></a></td>
												</tr>
											<?php
										}
									}
