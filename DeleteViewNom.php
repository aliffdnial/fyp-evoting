            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ADMINISTRATOR DELETE NOMINEES</h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">DELETE NOMINEES</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="chart-area" style="height:2300px;">
									<?php
									$host = "localhost";
									$username = "root";
									$password = "";
									...
									if (!$conn) {
									  die("Connection failed: " . mysqli_connect_error());
										...
										//to get data/records from a table Nominee

										$queryGet = "select * from NOMINEE";

										$resultGet = mysqli_query($conn, $queryGet); //assign query result to a variable 

										if(!$resultGet) //to check if query result IS NOT OK
										{
											die ("Invalid Query - get Nominee List: ".mysqli_error($conn));
										}
										else
										{
										//query result is OK
									...
									<tr>
									<th> </th> 
									<th> Nominee ID</th> <!-- Header for Nominee ID -->
									...
									<form action="DeleteNom.php" name="DeleteForm" method="POST" onSubmit="return confirm('Are you sure to delete this record?')">
									<?php
									...
									<tr>
										...
										<td><?php echo $baris['id'];//Id of Nominee?></td>
										<td><?php echo $baris['party'];//Party?> <br><img src="<?php echo $baris['logo'];//Logo?>" width="100px";></td>
										<td><?php echo $baris['name'];//Name?></td>
										<td><?php echo $baris['age'];//Age?></td>
										<td><?php echo $baris['education'];//Education?></td>
										<td><?php echo $baris['manifesto'];//Manifesto?></td>
										<td><img src="<?php echo $baris['image'];//Image?>" width="150px";></td>
									</tr>
									<?php
										}
									?>
									...
									<!-- Upon click on Delete button, it will go to deletenom.php page to delete nominee -->
									</form>
									<?php
										}
									}
