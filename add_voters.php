            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ADMINISTRATOR ADD VOTERS</h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">ADD VOTERS</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="chart-area" style="height:1200px;">
										<form method="POST" action="add_votersSubmit.php" role="form">
										...
										<div class="form-group row">
											<div class="col-sm-6 mb-3 mb-sm-0">
												...
												<input required type="text" name="name" class="form-control" placeholder="Name" autocomplete="off">
												<!-- To Insert Name -->
											</div>
										</div>
										...
										<div class="form-group row">
											<div class="col-sm-6 mb-3 mb-sm-0">
												...
												<input required type="text" name="district" class="form-control" placeholder="example: Shah Alam / Bukit Jelutong / Kota Kemuning" autocomplete="off">
												<!-- To Insert District -->
											</div>
										</div>
									...
									//Query to display voters that exists in database
									?>
									<div class="table-responsive">
										<table class="table table-bordered table-condensed table-striped">
											...
											<tr>
												...
												<td><a href="EditViewVot.php?id=<?php echo $row['id']; //To Edit ?>"><i class="far fa-edit"></i></a></td>
												<td><a href="DeleteViewVot.php?id=<?php echo $row['id']; //To Delete ?>"><i class="far fa-trash-alt"></i></a></td>
											</tr>
											<?php
												}
											}
