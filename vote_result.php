			...
			<div class="col-xl-12 col-lg-7">
				<div class="card shadow mb-4">
					...
					<div class="card-body">
						...
						<?php 
							if ($_SESSION["district"] == "Shah Alam" || "Bukit Jelutong" || "Kota Kemuning") { 
						?> <!-- Only display the result for district of the login session -->

						<div class="col-md-3">
							<h3>Organization</h3><hr>
						...
						<div class="col-md-9">
						<!-- Checks for a variable "organization" in the URL, return true if organization is a parameter that gets passed to GET Array -->
						<?php
						...
						?>
							...
							<hr>
							<!-- Prepare statement to read position by organization from database -->
							<?php
							...
							<?php if($rtnReadPos) { ?>
								...
								<h5><?php echo $rowPos['pos'];  ?></h5>
									<!-- Prepare statement to read nominee by position from database -->
									<?php
									...
									<div class="table-responsive">
										...
										<table class="table table-condensed table-striped">
											...
											<!-- Prepare statement to read number of votes they received from database -->
