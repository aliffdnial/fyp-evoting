                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-area" style="height:800px;">
										<form method="POST" action="add_posSubmit.php" role="form">
											...
											<!-- Choose What Position will be there from the list for the organization -->
										...
										<br><br>
										<!-- List of Organization & Position will be display -->
										<h4>List of Positions</h4><hr>
										<?php
										$conn = mysqli_connect("localhost","root","","evoting");
										$query = "select * from positions";
										$query_run = mysqli_query($conn,$query);
										//Query to display Position that exists in database
										?>
											...
											<table class="table table-bordered table-condensed table-striped">
												...
												if(mysqli_num_rows($query_run) > 0) //record is there or not
												{
													...
													<tr>
														...
														<td><a href="EditViewPos.php?id=<?php echo $row['id']; //To Edit ?>"><i class="far fa-edit"></i></a></td>
														<td><a href="DeleteViewPos.php?id=<?php echo $row['id']; //To Delete ?>"><i class="far fa-trash-alt"></i></a></td>
													</tr>
													<?php
													}
												}
