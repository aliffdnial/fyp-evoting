...
<!-- Will execute this if usertype == Admin -->
<?php 
...
?>
<!-- Execute this if usertype != Admin -->
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<div class="chart-area" style="height:500px;">
				...
				<center><h2 style=" background: -webkit-linear-gradient(#1E90FF, #008080); -webkit-background-clip: text; -webkit-text-fill-color: transparent;}">Welcome to the online voting system, <?php echo $_SESSION['UName']; //Display username of login user?></h2></center>
			</div>
		</div>
	</div>
</div>
