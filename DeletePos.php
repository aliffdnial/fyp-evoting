                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
									...
									$queryDelete = "delete from POSITIONS where id = '".$id."' ";
									...
									die ("Query bermasalah : ".mysqli_error($conn));
										...
										echo "<center><div class='alert alert-danger'>Position was deleted successfully.
											<br><a href='add_pos.php'> Go Back !</a></div></center>";
										}
									}
									?>
									</div>
