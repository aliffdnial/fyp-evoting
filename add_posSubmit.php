            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ADMINISTRATOR ADD POSITION</h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
									...
									$sql="select * from positions where (org='$organization' and pos='$position');"; 
									//Check whether organization & position already exist in database or not

									$res=mysqli_query($hubungan,$sql);

									if (mysqli_num_rows($res) > 0) {
											$row = mysqli_fetch_assoc($res);
											if($organization==isset($row['org']) && $position==isset($row['pos']))
											{
												echo "<center><div class='alert alert-danger'>Sorry, the position already exists in our database<br> <a href='add_pos.php'> Go Back !</a></div></center>";
											}
									}else{
										//put query to insert record
										$q1 = "insert into positions (org,pos)
										values ('".$organization."','".$position."')"; 
										...
										if(!$resultInsert){
											...
											echo "<div class='alert alert-success'>Position was inserted successfully.<a href='add_pos.php'> Go Back!</a></div>";
										}
									}
									?>
									</div>
