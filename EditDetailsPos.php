            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ADMINISTRATOR EDIT POSITION</h1>
                    </div>
                                ...
                                <div class="card-body">
									...
									if (!$conn) {
									  die("Connection failed: " . mysqli_connect_error());
										...
										$queryGet = "select * from POSITIONS where id = '".$id."' ";
										...
										//query result is OK
									?>
									<form action="EditPos.php" name="UpdateForm" method="POST" >
									...
									Position ID: <?php echo $baris['id']; ?>
									 
									<br><br>Position: <input type="text" name="pos" value="<?php 
									echo $baris['pos']; //To Edit Position ?>" maxlength="20" size ="35" required>
									<?php
										}
									?>
									<br><br>
									...
									<!-- Upon click on Update button, it will go to editpos.php page to update the edited name of position -->
									</form>
									<?php
										}
									}
