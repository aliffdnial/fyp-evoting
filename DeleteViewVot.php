            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ADMINISTRATOR DELETE VOTERS</h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">DELETE VOTERS</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
									...
									<form action="DeleteVot.php" name="DeleteForm" method="POST" onSubmit="return confirm('Are you sure to delete this record?')">
									<?php
									...
									<tr>
										...
										<td><?php echo $baris['id'];//Id of User ?></td> 
										<td><?php echo $baris['username'];//Username ?></td>
										<td><?php echo $baris['email'];//Email ?></td>
										<td><?php echo $baris['password'];//Password ?></td>
										<td><?php echo $baris['name'];//Name ?></td>
										<td><?php echo $baris['usertype'];//User Type ?></td>
										<td><?php echo $baris['district'];//District ?></td>
									</tr>
									<?php
										}
									?>
									...
									<!-- Upon click on Delete button, it will go to deletevot.php page to delete user -->
									</form>
									<?php
										}
									}
