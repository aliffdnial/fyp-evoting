        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<div class="d-sm-flex align-items-center justify-content-between mb-4">
					<h1 class="h3 mb-0 text-gray-800">ADMINISTRATOR :: PRINT RESULTS</h1>
				</div>
					...
					<div class="col-xl-12 col-lg-7">
						<div class="card shadow mb-4">
							...
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								<h6 class="m-0 font-weight-bold text-primary">VOTE RESULTS</h6>
							...
							<!-- Card Body -->
							<div class="card-body">
								<div class="chart-area" style="height:1000px;">
									<?php
									if(!isset($_GET['organization'])) {
										...
										<div class="logo-title">
											<table>
												<tr>
													<!-- <td><img src="logo.png" width="70"></td> -->
													<td><br/>
												...
												<div class="table-responsive">
													...
													<?php while($rowCountVotes = $rtnReadNomOrgPos->fetch_assoc()) { ?>
															...
															<tr>
																...
																<td style="width: 10%;"><?php echo $rowCountVotes['party']; ?><br>
																<img src="<?php echo $rowCountVotes['logo']; //Logo?>" width="100px";></td>
																<td style="width: 10%;"><?php echo $rowCountVotes['name']; ?></td>
																<td style="width: 10%;"><?php echo $rowCountVotes['age']; ?></td>
																<td style="width: 10%;"><?php echo $rowCountVotes['education']; ?></td>
