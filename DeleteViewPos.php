            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ADMINISTRATOR DELETE POSITION</h1>
                    </div>
                                ...
                                <div class="card-body">
									...
									if (!$conn) {
									  die("Connection failed: " . mysqli_connect_error());
										...
										//to get data/records from a table Position

										$queryGet = "select * from POSITIONS";

										$resultGet = mysqli_query($conn, $queryGet); //assign query result to a variable 

										if(!$resultGet) //to check if query result IS NOT OK
										{
											die ("Invalid Query - get Position List: ".mysqli_error($conn));
										}
										else
										{
										//query result is OK
									...
									<tr>
									<th> </th> 
									<th> Position ID</th> <!-- Header for Position ID -->
									<th> Position Name</th> <!-- Header for Position Name -->
									</tr>
									<form action="DeletePos.php" name="DeleteForm" method="POST" onSubmit="return confirm('Are you sure to delete this record?')">
									<?php
									...
									?>
										<tr>
											...
											<td><?php echo $baris['id'];//Id of Position ?></td> 
											<td><?php echo $baris['pos'];//Position ?></td>
										</tr>
									<?php
										}
									?>
									...
									<!-- Upon click on Delete button, it will go to deletepos.php page to delete position -->
									</form>
									<?php
											}
									}
